...
class Robot(object):
    def __init__(self):
        ...
        self._service_get_parts_from_stand = rospy.Service(PREFIX +'/get_parts', SetValue, self._response_get_parts_from_stand)
    ...
    def _response_drop_parts(self, req):
        ...
        rospy.Timer(rospy.Duration(WAIT_TIME_PER_PART * len(self._carried_parts.queue)), self._timed_task_finished, oneshot=True)
